...
class AppWithNotificationsStore = _AppWithNotificationsStore
    with _$AppWithNotificationsStore;
...
abstract class _AppWithNotificationsStore extends BaseStore with Store {
  ...
  NotificationMessage get clickedNotification =>
      notificationsStore.clickedNotification;

  @computed
  NotificationMessage get receivedNotification =>
      notificationsStore.receivedNotification;
}
