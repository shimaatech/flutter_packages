...
@freezed
abstract class StringList with _$StringList {
...
@freezed
abstract class IntList with _$IntList {
...
@freezed
abstract class DoubleList with _$DoubleList {
  factory DoubleList(List<double> data) = _DoubleList;

  factory DoubleList.fromJson(Map<String, dynamic> json) => _$DoubleListFromJson(json);
